// ignore_for_file: unnecessary_null_comparison, prefer_if_null_operators, prefer_typing_uninitialized_variables, avoid_print, prefer_null_aware_operators, prefer__ructors, unnecessary_, use_full_hex_values_for_flutter_colors, unused_field, unused_import, depend_on_referenced_packages
...
// import 'package:voicee_n_sms/main.dart';
// import 'package:voicee_n_sms/model/clslogs.dart';
// import 'package:voicee_n_sms/widgets/myAppbar.dart';
// import 'package:voicee_n_sms/widgets/mydrawer.dart';
// import 'package:voicee_n_sms/widgets/title_widget.dart';
...
class _FollowUpsPageState extends State<FollowUpsPage> {
  ...
  Future<List<FollowUpsModel>>? _func;
  Future<List<FollowUpsModel>> getListFollowUps() async {
    String uri = "${LoginService.cccIP}/webresources/GetCCCFollowupList?";
